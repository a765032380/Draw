package com.example.gll.myapplication.pageturn.factory;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.Canvas;

import com.example.gll.myapplication.BitmapUtil;
import com.example.gll.myapplication.pageturn.utils.BitmapUtils;
import com.example.gll.myapplication.pageturn.utils.ScreenUtils;
...
public class PicturesPageFactory extends PageFactory {
    ...
    private Bitmap getBitmapFromIds(int index){
        if (index==0){
            return BitmapUtil.textToBitmap("aaa",context);
        }
